...
public class YuunaLivePlayerCapeFeatureRenderer
    ...
    @Override
    public void render(@NotNull PoseStack matrixStack, @NotNull MultiBufferSource vertexConsumerProvider, int i, YuunaLivePlayerEntity player, float f, float g, float h, float j, float k, float l) {
